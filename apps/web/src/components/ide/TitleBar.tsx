  ...
  if (!isConnected) {
    return (
      ...
      >
        ...
        <span className="flex items-center gap-1">Connect Git <span className="text-[10px] opacity-60">(push/pull)</span></span>
      </button>
    );
  }
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        title={`Git: @${user?.login} (push/pull)`}
      >
        {user?.avatar_url ? (
        ...
        <span className="text-[10px] text-[#3fb950] font-semibold">Git</span>
      </button>

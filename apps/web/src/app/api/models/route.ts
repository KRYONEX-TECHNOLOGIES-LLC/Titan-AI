...
const MODEL_REGISTRY: ModelInfo[] = [
  ...
  },
  {
    ...
    costPer1MInput: 3,
    costPer1MOutput: 15,
    description: 'High quality coding with lower latency',
  },
  {
    id: 'gpt-4.1',
    name: 'GPT-4.1',
    ...
    costPer1MInput: 5,
    costPer1MOutput: 15,
    description: 'Stable general-purpose coding model',
  },
  {
    id: 'gemini-1.5-pro',
    name: 'Gemini 1.5 Pro',
    ...
    costPer1MInput: 1.25,
    costPer1MOutput: 5,
    description: 'Long-context reasoning and code generation',
  },
  {

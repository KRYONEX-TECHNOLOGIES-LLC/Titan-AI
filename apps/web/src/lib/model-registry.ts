...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  { id: 'titan-protocol', providerModelId: 'anthropic/claude-opus-4.6', name: 'Titan Protocol', provider: 'Titan AI', tier: 'frontier', contextWindow: 1000000, maxOutputTokens: 32000, supportsThinking: true, supportsVision: true, supportsTools: true, costPer1MInput: 2, costPer1MOutput: 8, description: 'Multi-agent governance mode — Opus 4.6 supervisor with Qwen 2.5 Coder 72B worker agent, mandatory verification and quality enforcement. Blended cost across cheap worker + premium supervisor.' },
  { id: 'titan-protocol-v2', providerModelId: 'anthropic/claude-opus-4.6', name: 'Titan Protocol v2 (Parallel)', provider: 'Titan AI', tier: 'frontier', contextWindow: 1000000, maxOutputTokens: 32000, supportsThinking: true, supportsVision: true, supportsTools: true, costPer1MInput: 1.5, costPer1MOutput: 6, description: 'Parallel multi-lane governance — Opus 4.6 supervisor orchestrates parallel Qwen3 Coder workers with DAG-scheduled execution, ruthless verification, and zero-trust merge arbitration. Blended cost across cheap workers + premium supervisor.' },

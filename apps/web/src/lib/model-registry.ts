...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  { id: 'deepseek-reasoner', providerModelId: 'deepseek/deepseek-reasoner', name: 'DeepSeek Reasoner', provider: 'DeepSeek', tier: 'standard', contextWindow: 64000, maxOutputTokens: 8192, supportsThinking: true, supportsVision: false, supportsTools: true, costPer1MInput: 0.55, costPer1MOutput: 2.19, description: 'Chain-of-thought verification with visible reasoning trace' },

...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  // 8 parallel lanes, Plan Mode integration, ~$5-15 for a complete 50-task app.
  { id: 'titan-plan-sniper', providerModelId: 'mistralai/devstral-2-2512', name: 'Titan Plan Sniper', provider: 'Titan AI', tier: 'frontier', contextWindow: 1000000, maxOutputTokens: 66000, supportsThinking: true, supportsVision: true, supportsTools: true, costPer1MInput: 0.15, costPer1MOutput: 0.75, description: '7-role model orchestra: Scanner (Devstral 2, FREE), Architect (MiMo-V2, FREE), Coder (MiniMax M2.1 / DeepSeek V3.2), Executor (Qwen3 Coder Next), Sentinel (Seed 1.6), Judge (Qwen3.5 Plus). 8 parallel lanes, Plan Mode integration. Complete apps for $5-15 vs $500-1000 with frontier models.' },

...
export type HarvestSource = 'github' | 'stackoverflow' | 'docs' | 'blog' | 'dataset' | 'reddit' | 'devto' | 'mdn' | 'wikipedia' | 'hackernews' | 'github-issues' | 'arxiv' | 'gitlab' | 'npm-docs' | 'competitive' | 'evol-instruct' | 'tech-news' | 'patents' | 'best-practices' | 'ai-research' | 'innovations' | 'finance' | 'real-estate' | 'business-strategy' | 'military-strategy' | 'chess-strategy' | 'books' | 'movies';
